...
export class ApplicantService {
  ...
  */
  ...
  addApplicant (applicant: Applicant) : Observable<string>  {
    ...
    let body = `firstname=${applicant.firstname}&lastname=${applicant.lastname}&email=${applicant.email}&telephone=${applicant.telephone}&address=${applicant.address}&city=${applicant.city}&zipcode=${applicant.zipcode}&citizen=${applicant.citizen}&felon=${applicant.felon}&feloncomment=${applicant.feloncomment}`;
